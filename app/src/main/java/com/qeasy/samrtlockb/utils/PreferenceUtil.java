...
public class PreferenceUtil {
    ...
    public static final String QUTO="quto";//额度
     ...
     * 从SP取数据
     ...
     String
     */
    public synchronized static String getSharedPreference(Context context,String getKey,String _default){
        String value="";
        value=context.getSharedPreferences(KBAS_BASE_PRE, 0).getString(getKey, _default);
        return value;
    ...
    public synchronized static  boolean bSharedPreference(Context context,String getKey,boolean _default){
        return  context.getSharedPreferences(KBAS_BASE_PRE,0).getBoolean(getKey,_default);
