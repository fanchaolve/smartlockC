  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      ...
      canvas.drawRect(frame.right - 10, frame.top, frame.right,
              frame.top + 50, paint);
      canvas.drawRect(frame.left, frame.bottom - 10, frame.left
              + 50, frame.bottom, paint);
      canvas.drawRect(frame.left, frame.bottom - 50, frame.left
              + 10, frame.bottom, paint);
      canvas.drawRect(frame.right - 50, frame.bottom
              - 10, frame.right, frame.bottom, paint);
      canvas.drawRect(frame.right - 10, frame.bottom
              - 50, frame.right, frame.bottom, paint);
